...
class DocumentViewerElement extends StatelessWidget {
  ...
  List<Widget> buildElement(BuildContext context) {
        ...
        Stack(
          children: [
            SizedBox(
              ...
              child: Padding(
                padding: EdgeInsets.only(top:  element.parent!.children.indexOf(element) > 0 ? 50 : 0, left: 30, right: 30),
                child: Text(
    ...
    final baseFontSize = MediaQuery.of(
      context,
    ).textScaler.scale((DefaultTextStyle.of(context).style.fontSize ?? 14)) * 1.3;
                  ...
                  configs: [
                    ...
                    PreConfig(
                      ...
                      wrapper: (child, code, language) {
                        return DefaultTextStyle(style:  GoogleFonts.sourceCodePro(
                        fontSize: baseFontSize * 1.0,
                        color: mdColor,
                      ), child: child);
                      },
                    ...
                    ListConfig(marker: (isOrdered, depth, index) {
                      return Padding(padding: EdgeInsets.only(right: 5), child: Text("${index + 1}.", textAlign: TextAlign.right, style: TextStyle( fontSize: baseFontSize * 1.0, height: 1.5)));
                    }),
                  ],
                  ),
      ...
      return [
        Container(
          decoration: BoxDecoration(
            color: Color.from(alpha: 1.0, red: .9, green: .9, blue: .9),
