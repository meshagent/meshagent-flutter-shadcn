...
class Range {
  ...
  bool operator ==(Object other) =>
      identical(this, other) || other is Range && runtimeType == other.runtimeType && start == other.start && end == other.end;
...
class RangeCompactList extends IterableMixin<Range> {
  ...
  void add(Range newItem) {
    ...
    final flushedList = _ranges.reversed.fold<List<Range>>(<Range>[newItem], (accumulator, range) {
      final newAcc = <Range>[];
  ...
  RangeCompactList operator &(Range otherRange) {
    final clampedRanges = _ranges.fold<List<Range>>(<Range>[], (acc, Range range) {
  ...
  bool operator ==(Object other) =>
      ...
      other is RangeCompactList && runtimeType == other.runtimeType && _kListEquality.equals(_ranges, other._ranges);
...
@immutable
class RangeIterable with IterableMixin<int> {
  final Range _range;
  ...
  @override
  bool operator ==(Object other) =>
      identical(this, other) || other is RangeIterable && runtimeType == other.runtimeType && _range == other._range;
