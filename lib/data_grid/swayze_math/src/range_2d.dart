...
class Range2D {
  ...
  const Range2D.fromLTRB(this.leftTop, this.rightBottom) : assert(leftTop != rightBottom), assert(leftTop <= rightBottom);
  ...
  const Range2D.fromLTWH(this.leftTop, IntVector2 size) : rightBottom = leftTop + size;
  ...
  bool overlaps(Range2D otherRange) => xRange.overlaps(otherRange.xRange) && yRange.overlaps(otherRange.yRange);

  /// Defines if this range contains [otherRange] entirely
  bool containsRange(Range2D otherRange) {
    return xRange.containsRange(otherRange.xRange) && yRange.containsRange(otherRange.yRange);
  }
  ...
  bool operator ==(Object other) =>
      ...
      other is Range2D && runtimeType == other.runtimeType && leftTop == other.leftTop && rightBottom == other.rightBottom;
