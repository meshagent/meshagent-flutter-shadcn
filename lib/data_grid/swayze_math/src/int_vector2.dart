...
class IntVector2 {
  ...
  const IntVector2.symmetric(int side) : dx = side, dy = side;

  IntVector2.from(IntVector2 other) : dx = other.dx, dy = other.dy;
  ...
  /// vectors
  IntVector2 operator -(IntVector2 otherVector) => IntVector2(dx - otherVector.dx, dy - otherVector.dy);
  ...
  bool operator ==(Object other) =>
      identical(this, other) || other is IntVector2 && runtimeType == other.runtimeType && dx == other.dx && dy == other.dy;
