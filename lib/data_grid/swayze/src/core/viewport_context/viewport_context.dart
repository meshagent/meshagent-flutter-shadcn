...
abstract class ViewportContext extends Listenable {
  ...
  /// scrollable ones.
  PixelResult positionToPixel(int globalPosition, Axis axis, {required bool isForFrozenPanes});
...
///   value of this state.
class ViewportAxisContext extends ChangeNotifier implements ValueListenable<ViewportAxisContextState> {
  final Axis axis;
...
class ViewportAxisContextState {
  ...
  bool operator ==(Object other) =>
      ...
      other is ViewportAxisContextState &&
          ...
          _kIntIterableEquality.equals(visibleFrozenIndices, other.visibleFrozenIndices);
...
class PositionResult {
  ...
  const PositionResult({required this.axis, required this.overflow, required this.position, required this.isFrozen});
  ...
  @override
  int get hashCode => axis.hashCode ^ overflow.hashCode ^ position.hashCode ^ isFrozen.hashCode;
}
...
class PixelResult {
  ...
  const PixelResult({required this.axis, required this.offscreenDetails, required this.pixel});
  ...
  @override
  int get hashCode => pixel.hashCode ^ offscreenDetails.hashCode ^ axis.hashCode;
}
...
class CellPositionResult {
  ...
  const CellPositionResult({this.isOffscreenY = false, this.isOffscreenX = false, required this.leftTop, required this.cellSize});

  factory CellPositionResult.offscreen({required bool isOffscreenY, required bool isOffscreenX}) {
    return CellPositionResult(leftTop: const Offset(0, 0), isOffscreenX: isOffscreenX, isOffscreenY: isOffscreenY, cellSize: Size.zero);
  }
  ...
  @override
  int get hashCode => isOffscreenX.hashCode ^ isOffscreenY.hashCode ^ leftTop.hashCode ^ cellSize.hashCode;
}
