...
class SwayzeHeaderPalette {
  ...
  bool operator ==(Object other) =>
      ...
      other is SwayzeHeaderPalette && runtimeType == other.runtimeType && background == other.background && foreground == other.foreground;
...
class SwayzeStyle {
  ...
  static late final defaultSwayzeStyle = SwayzeStyle(
    defaultHeaderPalette: const SwayzeHeaderPalette(background: Color(0xFFF7F7F7), foreground: Color(0xFF6F6F6F)),
    selectedHeaderPalette: const SwayzeHeaderPalette(background: Color(0xFFFFC800), foreground: Color(0xFF000000)),
    ...
    inlineEditorShadow: const [BoxShadow(color: Color(0x33000000), blurRadius: 10, offset: Offset(2, 2))],
  );
  ...
  /// Optional cap to apply when auto fitting rows.
  final double? maxAutoFitRowExtent;

  /// Whether to render the table's leading outer borders on the top and left.
  ...
  SwayzeStyle copyWith({
    ...
    return SwayzeStyle(
      ...
      selectedHeaderPalette: selectedHeaderPalette ?? this.selectedHeaderPalette,
      ...
      defaultCellBackground: defaultCellBackground ?? this.defaultCellBackground,
      cellSeparatorColor: cellSeparatorColor ?? this.cellSeparatorColor,
      cellSeparatorStrokeWidth: cellSeparatorStrokeWidth ?? this.cellSeparatorStrokeWidth,
