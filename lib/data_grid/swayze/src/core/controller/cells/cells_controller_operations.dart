...
/// the cell matrix.
class PutCellOperation<CellDataType extends SwayzeCellData> extends CellOperation<CellDataType> {
  ...
  void commit(MatrixMap<CellDataType> matrix) {
    ...
    if (cellData.isEmpty) {
      matrix.remove(colIndex: cellData.position.dx, rowIndex: cellData.position.dy);
      return;
    }
  ...
  bool operator ==(Object other) =>
      identical(this, other) || other is PutCellOperation && runtimeType == other.runtimeType && cellData == other.cellData;
...
/// on [position].
class DeleteCellOperation<CellDataType extends SwayzeCellData> extends CellOperation<CellDataType> {
  ...
  @override
  void commit(MatrixMap<CellDataType> matrix) {
    matrix.remove(colIndex: position.dx, rowIndex: position.dy);
  }

  @override
  bool operator ==(Object other) =>
      identical(this, other) || other is DeleteCellOperation && runtimeType == other.runtimeType && position == other.position;
