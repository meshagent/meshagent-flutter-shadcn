...
abstract class SwayzeCellData {
  ...
  const SwayzeCellData({required this.id, required this.position});
  ...
  @override
  int get hashCode => id.hashCode ^ position.hashCode ^ contentAlignment.hashCode ^ hasVisibleContent.hashCode;
}
