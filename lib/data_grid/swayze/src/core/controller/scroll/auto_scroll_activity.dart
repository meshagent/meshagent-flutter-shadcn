...
/// [GrowthDirection].
double _getMaxToScroll({double? maxToScroll, required ScrollPosition position, required GrowthDirection direction}) {
  final extent = direction == GrowthDirection.forward ? position.extentAfter : position.extentBefore;
...
class AutoScrollActivity extends ScrollActivity {
  ...
  AutoScrollActivity({
    ...
    double? maxToScroll,
  }) : maxToScroll = _getMaxToScroll(maxToScroll: maxToScroll, direction: direction, position: position),
       super(delegate);
  ...
  void onTick(double deltaTime) {
    ...
    final deltaDistance = direction == GrowthDirection.forward ? -distance : distance;
