...
abstract class UserSelectionModel extends Selection {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is UserSelectionModel && runtimeType == other.runtimeType;
...
class TableUserSelectionModel implements UserSelectionModel {
  ...
  TableUserSelectionModel._({String? id, required this.anchorCoordinate}) : id = id ?? _uuid.v4(), super();

  factory TableUserSelectionModel.fromSelectionModel(UserSelectionModel original) {
    return TableUserSelectionModel._(id: original.id, anchorCoordinate: original.anchorCoordinate);
  }
...
class HeaderUserSelectionModel extends AxisBoundedSelection implements UserSelectionModel {
  ...
  HeaderUserSelectionModel._({
    ...
    required this.style,
       ...
       super.crossAxisUnbounded(axis: boundedAxis, anchorEdge: anchorEdge, start: start, end: end);
  ...
  factory HeaderUserSelectionModel.fromAnchorFocus({
    ...
    return HeaderUserSelectionModel._(id: id, anchorEdge: anchorEdge, start: start, end: end, boundedAxis: axis, style: style);
  }
  ...
  factory HeaderUserSelectionModel.fromSelectionModel(
    ...
    return HeaderUserSelectionModel.fromAnchorFocus(id: original.id, anchor: anchor, focus: focus, axis: axis, style: original.style);
  }
  ...
  HeaderUserSelectionModel copyWith({int? anchor, int? focus, Axis? axis, SelectionStyle? style}) =>
  ...
  bool operator ==(Object other) =>
      identical(this, other) ||
      super == other && other is HeaderUserSelectionModel && runtimeType == other.runtimeType && id == other.id && style == other.style;
...
/// cells in the axis.
class CellUserSelectionModel extends BoundedSelection implements UserSelectionModel {
  @override
  final String id;
  ...
  CellUserSelectionModel._({
    ...
    required this.style,
       ...
       super(leftTop: leftTop, rightBottom: rightBottom, anchorCorner: anchorCorner);
  ...
  factory CellUserSelectionModel.fromAnchorFocus({
    ...
    final leftTop = IntVector2(min(anchor.dx, focus.dx), min(anchor.dy, focus.dy));

    // Focus and anchor are inclusive, rightBottom on Range2D is not.
    final rightBottom = IntVector2(max(anchor.dx, focus.dx) + 1, max(anchor.dy, focus.dy) + 1);
    ...
    return CellUserSelectionModel._(id: id, leftTop: leftTop, rightBottom: rightBottom, anchorCorner: anchorCorner, style: style);
  }
  ...
  factory CellUserSelectionModel.fromSelectionModel(UserSelectionModel original, {required IntVector2 anchor, required IntVector2 focus}) {
    return CellUserSelectionModel.fromAnchorFocus(id: original.id, anchor: anchor, focus: focus, style: original.style);
  }
  ...
  /// Calling this method on a selection will return a new transformed selection
  /// based on the provided properties.
  CellUserSelectionModel copyWith({IntVector2? anchor, IntVector2? focus, SelectionStyle? style}) =>
      CellUserSelectionModel.fromAnchorFocus(id: id, anchor: anchor ?? this.anchor, focus: focus ?? this.focus, style: style ?? this.style);

  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
      super == other && other is CellUserSelectionModel && runtimeType == other.runtimeType && id == other.id && style == other.style;
