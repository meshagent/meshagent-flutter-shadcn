...
class SwayzeSelectionController extends Listenable implements ControllerBase {
  ...
  late final _mergeListenable = Listenable.merge([userSelections, dataSelectionsValueListenable]);
  ...
  void updateUserSelections(UserSelectionState Function(UserSelectionState previousState) stateUpdate) {
...
class _DummyDataSelectionsValueNotifier implements ValueListenable<Iterable<Selection>> {
  @override
  void addListener(VoidCallback listener) {}
