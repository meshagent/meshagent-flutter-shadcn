...
extension SelectionMethods on Selection {
  ...
  Range2D bound({required Range2D to}) {
...
abstract class AxisBoundedSelection extends Range implements SelectionWithEdges<int> {
  ...
  IntVector2 get focusCoordinate {
    ...
    return axis == Axis.horizontal ? IntVector2(focus, crossAxisValue) : IntVector2(crossAxisValue, focus);
  }
  ...
  IntVector2 get anchorCoordinate {
    final crossAxisValue = crossAxisBound ?? 0;
    return axis == Axis.horizontal ? IntVector2(anchor, crossAxisValue) : IntVector2(crossAxisValue, anchor);
  }
  ...
  @override
  int get hashCode => super.hashCode ^ crossAxisBoundedEdge.hashCode ^ crossAxisBound.hashCode ^ axis.hashCode ^ anchorEdge.hashCode;
}
...
abstract class BoundedSelection extends Range2D implements SelectionWithEdges<IntVector2> {
  /// Defines which [Corner] represents the [anchorCoordinate]
  final Corner anchorCorner;

  BoundedSelection({required IntVector2 leftTop, required IntVector2 rightBottom, required this.anchorCorner})
  ...
  bool operator ==(Object other) =>
      identical(this, other) ||
      super == other && other is BoundedSelection && runtimeType == other.runtimeType && anchorCorner == other.anchorCorner;
