...
typedef TwoAxisScrollBuilder =
    Widget Function(BuildContext context, double verticalDisplacement, double horizontalDisplacement, bool isOffscreen);
...
class _SliverTwoAxisScrollState extends State<SliverTwoAxisScroll> {
        ...
        return _TableSizeImplicitAnimation(
          ...
          builder: (context, double verticalExtent, Widget? child) {
            return SliverScrollingDataBuilder(
              ...
              extent: verticalExtent,
              contentBuilder: (BuildContext context, ScrollingData verticalScrollingData) {
                  ...
                  contentBuilder: (context, verticalVirtualizationState) {
                    return ValueListenableBuilder<SwayzeHeaderState>(
                      ...
                      builder: (context, columnsState, child) {
                        ...
                        // the rows header.
                        final horizontalExtent = columnsState.extent + rowHeaderWidth;

                        return _TableSizeImplicitAnimation(
                          extent: horizontalExtent,
                          builder: (context, double horizontalExtent, Widget? child) {
                            final horizontalCustomSliver = SliverScrollingDataBuilder(
                              leadingPadding: rowHeaderWidth,
                              extent: horizontalExtent,
                              contentBuilder: (context, horizontalScrollingData) {
                                return VirtualizationCalculator(
                                  headerSize: rowHeaderWidth,
                                  scrollingData: horizontalScrollingData,
                                  axis: Axis.horizontal,
                                  frozenAmount: columnsState.frozenCount,
                                  contentBuilder: (context, horizontalVirtualizationState) {
                                    return _buildContent(context, horizontalVirtualizationState, verticalVirtualizationState);
                                  },
                                );
                              },
                            );
  ...
  Widget _buildContent(
    ...
    final isOffscreen =
        verticalScrollingData.viewportExtent == 0 ||
        verticalScrollingData.constraints.scrollOffset >= tableDataController.rows.value.extent;
...
class _TableSizeImplicitAnimation extends StatefulWidget {
  ...
  const _TableSizeImplicitAnimation({Key? key, required this.builder, required this.extent}) : super(key: key);

  @override
  State<_TableSizeImplicitAnimation> createState() => _TableSizeImplicitAnimationState();
}

class _TableSizeImplicitAnimationState extends State<_TableSizeImplicitAnimation> {
  ...
  void restartDebounce() {
    ...
    _animateRepeatDebounce = Timer(config.kDefaultScrollAnimationDuration, () => _animateRepeatDebounce = null);
  }
  ...
  void didUpdateWidget(_TableSizeImplicitAnimation oldWidget) {
    ...
    if (widget.extent != oldWidget.extent) {
      final isDeltaSeverelyNegative = widget.extent - oldWidget.extent < -_kSevereTableSizeChangeThreshold;
