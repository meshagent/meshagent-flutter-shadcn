...
class TableFocusState {
  ...
  const TableFocusState({required this.hasFocus, required this.isActive});
  ...
  bool operator ==(Object other) =>
      ...
      other is TableFocusState && runtimeType == other.runtimeType && hasFocus == other.hasFocus && isActive == other.isActive;
