...
class ExpandAll extends MultiChildRenderObjectWidget {
  ExpandAll({Key? key, List<Widget> children = const <Widget>[]}) : super(key: key, children: children);
...
class _RenderExpandAll extends RenderBox
    with ContainerRenderObjectMixin<RenderBox, _ExpandAllData>, RenderBoxContainerDefaultsMixin<RenderBox, _ExpandAllData> {
  @override
