...
class CellRootPainter extends MultiChildRenderObjectWidget {
  ...
  }) : super(key: key, children: <Widget>[cellContent, ...cellHoverWidgets]);
  ...
  @override
  void updateRenderObject(BuildContext context, _RenderCellRootPainter renderObject) {
...
class _RenderCellRootPainter extends RenderBox
    with ContainerRenderObjectMixin<RenderBox, _CellRootParentData>, RenderBoxContainerDefaultsMixin<RenderBox, _CellRootParentData> {
  ...
  @override
  void performLayout() {
    final lineStrokeCompensation = Offset(-cellSeparatorStrokeWidth, -cellSeparatorStrokeWidth);
  ...
  bool hitTestChildren(BoxHitTestResult result, {required Offset position}) {
    ...
    final cellContentParentData = cellContent.parentData! as _CellRootParentData;
    ...
    var cellHoverChild = (cellContent.parentData! as _CellRootParentData).nextSibling;
