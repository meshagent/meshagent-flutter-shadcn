...
class _PrimarySelectionState extends State<PrimarySelection> with SelectionRenderingHelpers {
  ...
  /// [SwayzeStyle].
  late final selectionStyle = widget.selectionModel.style ?? InternalScope.of(context).style.userSelectionStyle;

  @override
  late final viewportContext = ViewportContextProvider.of(context);

  late final tableDataController = InternalScope.of(context).controller.tableDataController;
  ...
  Widget build(BuildContext context) {
    ...
    final isSingleCell = selectionModel is CellUserSelectionModel && selectionModel.isSingleCell;
    ...
    return _AnimatedPrimarySelection(
      ...
      decoration: BoxDecoration(color: selectionStyle.backgroundColor, border: getVisibleBorder(range, borderSide).toFlutterBorder()),
...
class _AnimatedSelectionState extends AnimatedWidgetBaseState<_AnimatedPrimarySelection> {
  late final viewportContext = ViewportContextProvider.of(context);
  ...
  void forEachTween(TweenVisitor<dynamic> visitor) {
    _left = visitor(_left, widget.offset.dx, (dynamic value) => Tween<double>(begin: value as double)) as Tween<double>?;
    _top = visitor(_top, widget.offset.dy, (dynamic value) => Tween<double>(begin: value as double)) as Tween<double>?;
    _size = visitor(_size, widget.size, (dynamic value) => SizeTween(begin: value as Size)) as SizeTween?;
  }
...
class PrimarySelectionPainter extends LeafRenderObjectWidget {
  ...
  _RenderPrimarySelectionPainter createRenderObject(BuildContext context) {
    return _RenderPrimarySelectionPainter(decoration, offset, size, activeCellRect, isSingleCell: isSingleCell);
  }

  @override
  void updateRenderObject(BuildContext context, _RenderPrimarySelectionPainter renderObject) {
    renderObject
      ..isSingleCell = isSingleCell
...
class _RenderPrimarySelectionPainter extends RenderBox {
  _RenderPrimarySelectionPainter(this._decoration, this._offset, this._definedSize, this._activeCellRect, {required bool isSingleCell})
  ...
  late final backgroundPaint = CachedValue(() => Paint()..color = _decoration.color!).withDependency(() => _decoration);
  ...
  void paint(PaintingContext context, Offset offset) {
    ...
    if (!_isSingleCell) {
      ...
      // crop active cell
      final overallPath = Path.combine(PathOperation.difference, selectionPath, activeCellPath);
