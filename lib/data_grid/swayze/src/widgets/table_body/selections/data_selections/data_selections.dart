...
class _DataSelectionsState extends State<DataSelections> with SelectionRenderingHelpers {
  @override
  ...
  Widget build(BuildContext context) {
    ...
    for (final dataSelection in widget.dataSelections) {
      ...
      final defaultBorderSide = dataSelection.style?.borderSide ?? const SelectionBorderSide.none();
