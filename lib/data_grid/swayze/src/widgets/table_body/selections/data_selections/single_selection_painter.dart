...
class SingleSelectionPainter extends LeafRenderObjectWidget {
  ...
  const SingleSelectionPainter({Key? key, required this.renderData}) : super(key: key);
  ...
  @override
  void updateRenderObject(BuildContext context, _RenderDataSelection renderObject) {
