...
class RectPositionsNotifier extends ValueNotifier<RectPositionsState> {
  RectPositionsNotifier({required Rect tableRect, required Rect cellRect})
    : super(RectPositionsState(tableRect: tableRect, cellRect: cellRect));

  Rect get cellRect => value.cellRect;

  Rect get tableRect => value.tableRect;

  void setRect({required Rect tableRect, required Rect cellRect}) {
    value = RectPositionsState(tableRect: tableRect, cellRect: cellRect);
  }
...
class RectPositionsState {
  ...
  bool operator ==(Object other) =>
      ...
      other is RectPositionsState && runtimeType == other.runtimeType && tableRect == other.tableRect && cellRect == other.cellRect;
