...
/// [Action.overridable]
abstract class DefaultSwayzeAction<T extends SwayzeIntent> extends ContextAction<T> {
  final InternalScope internalScope;
  final ViewportContext viewportContext;

  DefaultSwayzeAction(this.internalScope, this.viewportContext);
  ...
  Action overridable(BuildContext context) {
    return Action.overridable(defaultAction: this, context: context);
  }
}
