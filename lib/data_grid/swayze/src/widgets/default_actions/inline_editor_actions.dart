...
class OpenInlineEditorAction extends DefaultSwayzeAction<OpenInlineEditorIntent> {
  OpenInlineEditorAction(InternalScope internalScope, ViewportContext viewportContext) : super(internalScope, viewportContext);
  ...
  void invokeAction(OpenInlineEditorIntent intent, BuildContext context) {
    ...
    final position = intent.cellPosition ?? selectionController.userSelectionState.activeCellCoordinate;

    inlineEditor.open(onCoordinate: position, withInitialText: intent.initialText);
  }
}
