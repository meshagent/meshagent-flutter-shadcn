...
class KeyedNotifierBuilder<Subject> extends StatefulWidget {
  ...
  const KeyedNotifierBuilder({Key? key, required this.keyedNotifier, required this.keyToListenTo, required this.builder}) : super(key: key);

  @override
  State<KeyedNotifierBuilder<Subject>> createState() => _KeyedNotifierBuilderState<Subject>();
}

class _KeyedNotifierBuilderState<Subject> extends State<KeyedNotifierBuilder<Subject>> {
  ...
  void init() {
    widget.keyedNotifier.setListenerForKey(widget.keyToListenTo, listener);
