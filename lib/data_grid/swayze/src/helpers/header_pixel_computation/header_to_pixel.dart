...
double getAxisHeaderOffset(int targetIndex, HeaderComputationAuxiliaryData headerComputationAuxiliaryData) {
  ...
  for (final customSizedHeaderIndex in headerComputationAuxiliaryData.orderedCustomSizedIndices) {
    ...
    customSizedHeadersInBetweenSize += headerComputationAuxiliaryData.customSizedHeaders[customSizedHeaderIndex]!.effectiveExtent;
  }

  // The amount of default sized headers preceeding in the given index
  final defaultSizedHeaderInBetweenCount = headersInBetween - customSizedHeadersInBetweenCount;

  // Sum up custom and default sized headers sizes
  final offset = customSizedHeadersInBetweenSize + (defaultSizedHeaderInBetweenCount * headerComputationAuxiliaryData.defaultSize);
