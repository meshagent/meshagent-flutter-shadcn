...
class FormDocumentViewer extends StatelessWidget {
  const FormDocumentViewer({super.key, required this.client, required this.document});
    ...
    return ChangeNotifierBuilder(
      ...
      builder: (context) => document.root.getChildren().isEmpty
          ...
          : Padding(
              ...
              child: ShadCard(
                title: document.root.getAttribute("title") != null ? Text(document.root.getAttribute("title")) : null,
                description: document.root.getAttribute("description") != null ? Text(document.root.getAttribute("description")) : null,
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      for (final fieldElement in document.root.getChildren()) ...[
                        FormDocumentField(element: fieldElement as doc.MeshElement),
  ...
  Widget build(BuildContext context) {
    return ChangeNotifierBuilder(
      ...
      builder: (context) => ShadSelectFormField<String?>(
        ...
        options: [
          for (final option in element.getChildren().whereType<doc.MeshElement>())
            ShadOption<String?>(value: option.getAttribute("value"), child: Text(option.getAttribute("text"))),
        ],
      ),
    );
  }
